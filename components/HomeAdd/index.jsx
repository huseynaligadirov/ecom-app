...
async function getCategoriesFromFirestore() {
  ...
  const categoryImages = {
    ...
    earring: 'https://i.pinimg.com/474x/d8/6c/2c/d86c2c9b682d634ce574df795bade08f.jpg',
    watch: 'https://i.pinimg.com/474x/51/b2/92/51b29250597ee90a811c2c3211aa8647.jpg',
    necklace: 'https://i.pinimg.com/474x/ae/f9/1f/aef91fd585f1b089eec38e0613083464.jpg',
  };
...
export default function HomeAddWrapper() {
  const [categories, setCategories] = useState([]);
  const [showAll, setShowAll] = useState(false);


  useState(() => {
    getCategoriesFromFirestore().then(setCategories);
  }, []);
      ...
      <div className="categories-container">
        ...
        {categories.length > 3 && (
          <div className="text-center mt-4">
            ...
            >
              {showAll ? 'Daha Az Göster' : 'Daha Fazla'}
            </button>
          </div>
        )}
      </div>
